      ...
      <div className="top-content">
        ...
        <p className="count">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <circle cx="12" cy="7.4" r="3.6" fill="none" stroke="currentColor" strokeWidth="2" />
            <path d="M5 20c.7-4 3.4-6 7-6s6.3 2 7 6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
          </svg>
          {place.traces}개의 흔적
        </p>
      </div>
