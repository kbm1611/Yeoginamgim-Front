    ...
    >
      ...
      >
        ...
        <button
          ...
          disabled={isSubmitting || (type === 'polaroid' && !selectedPhoto)}
          style={{
            borderRadius: 999,
            backgroundColor: (isSubmitting || (type === 'polaroid' && !selectedPhoto)) ? '#C0B0A0' : '#2C1A0E',
            padding: '8px 20px', fontSize: 13, fontWeight: 700, color: '#fff',
            cursor: (isSubmitting || (type === 'polaroid' && !selectedPhoto)) ? 'not-allowed' : 'pointer',
