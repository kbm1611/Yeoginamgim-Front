...
assert.match(signupPage, /useEffect/)
assert.match(signupPage, /useRef/)
...
assert.match(signupPage, /window\.clearTimeout/)
assert.match(signupPage, /signupRedirectTimeoutRef\.current/)
